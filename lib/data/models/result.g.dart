...
extension ResultQueryFilter on QueryBuilder<Result, Result, QFilterCondition> {
  QueryBuilder<Result, Result, QAfterFilterCondition> dateTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> dateTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> dateTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> dateTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> scoreEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'score',
        value: value,
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> scoreGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> scoreLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterFilterCondition> scoreBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ResultQuerySortBy on QueryBuilder<Result, Result, QSortBy> {
  QueryBuilder<Result, Result, QAfterSortBy> sortByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<Result, Result, QAfterSortBy> sortByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QAfterSortBy> sortByScore() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'score', Sort.asc);
    });
  }

  QueryBuilder<Result, Result, QAfterSortBy> sortByScoreDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ResultQuerySortThenBy on QueryBuilder<Result, Result, QSortThenBy> {
  QueryBuilder<Result, Result, QAfterSortBy> thenByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<Result, Result, QAfterSortBy> thenByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.desc);
    });
  }
  ...
  QueryBuilder<Result, Result, QAfterSortBy> thenByScore() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'score', Sort.asc);
    });
  }

  QueryBuilder<Result, Result, QAfterSortBy> thenByScoreDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'score', Sort.desc);
    });
  }
...
extension ResultQueryWhereDistinct on QueryBuilder<Result, Result, QDistinct> {
  QueryBuilder<Result, Result, QDistinct> distinctByDateTime() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, Result, QDistinct> distinctByScore() {
    return QueryBuilder.apply(this, (query) {
...
extension ResultQueryProperty on QueryBuilder<Result, Result, QQueryProperty> {
  ...
  QueryBuilder<Result, DateTime, QQueryOperations> dateTimeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Result, int, QQueryOperations> scoreProperty() {
    return QueryBuilder.apply(this, (query) {
